							...
							<div class="panel-body">
								<div class="row">
									<div class="col-lg-6">
										...
										%>
										<form role="form" method="post" action="AnalyticsController">
											<input type="hidden" name="envi" value="MOB_SIT"> <label>Report</label>
											<div class="form-group">
												...
												<p class="help-block">Please choose a Report</p>
											</div>
											<div class="form-group">
